...
public class MW_get
{
  ...
  public static void main(String[] args)
  {
      ...
      String id = (String)form_data.get("MW_cust_ID_old");
	  String password = (String)form_data.get("MW_password_old");
	  //new customer
	  Boolean IsCustomer = true; 
	  if(id.equals(""))
	  {
	        id = (String)form_data.get("MW_cust_ID_new");
			password = (String)form_data.get("MW_password_new");
			IsCustomer = false;
	  }
	  ...
	  if(found)
	  {
			...
			{
				System.out.println("<h2 style=\"background: #E6E6FA\">You are already in our file.<br />Go back!<br />Your customer ID is: " + id +"<br />and password: " + password + "<br /></h2>");
			}
	  }
	  else
	  {
			if(IsCustomer)
			{
				System.out.println("<h2 style=\"background: #E6E6FA\">SORRY,<br />you are not in our file!</h2>");
			}
			else
			{
				try 
